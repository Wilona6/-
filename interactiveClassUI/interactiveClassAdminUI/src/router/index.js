    ...
    children: [
      {
        ...
        meta: { title: '试题管理', icon: 'form', role: ['teacher', 'admin'] }
      }
    ...
    children: [
      {
        ...
        meta: { title: '公告管理', icon: 'form', role: ['teacher', 'admin'] }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'index',
        name: '试题管理',
        component: () => import('@/views/paper/student.vue'),
        meta: { title: '学生试题', icon: 'form' }
      }
    ]
  }
