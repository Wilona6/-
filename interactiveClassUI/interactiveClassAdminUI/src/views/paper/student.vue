...
<!--        <el-table-column label="课程" align="center" prop="courseName" />-->
        ...
        <el-table-column label="学生测试卷" align="center" prop="questionUrl">
...
export default {
  ...
  methods: {
    ...
    async listPageData() {
      ...
      this.tableData = data.data.list.filter(v=>v.paperId==this.courseId)
    ...
    handleDowload(row) {
      const url = uploadUrl + '/file/' + row.questionUrl
